...
#define ERRORS                                                                 \
  {                                                                            \
    /*  0*/ "Success", /*  1*/ "Operation not permitted",                      \
        ...
        /* 99*/ "Cannot assign requested address", /*100*/ "Network is down",  \
        ...
        /*124*/ "Wrong medium type", /*125*/ "Operation canceled",             \
        /*126*/ "Required key not available", /*127*/ "Key has expired",       \
        /*128*/ "Key has been revoked", /*129*/ "Key was rejected by service", \
        /*130*/ "Owner died", /*131*/ "State not recoverable",                 \
        /*132*/ "Operation not possible due to RF-kill",                       \
        /*133*/ "Memory page has hardware error", /*max*/ "Unknown error "     \
  }
...
#define ERRORS                                                               \
  {                                                                          \
    /*  0*/ "Undefined error: 0", /*  1*/ "Operation not permitted",         \
        ...
        /* 12*/ "Cannot allocate memory", /* 13*/ "Permission denied",       \
        /* 14*/ "Bad address", /* 15*/ "Block device required",              \
        /* 16*/ "Resource busy", /* 17*/ "File exists",                      \
        ...
        /* 88*/ "Malformed Mach-o file", /* 89*/ "Operation canceled",       \
        /* 90*/ "Identifier removed", /* 91*/ "No message of desired type",  \
        /* 92*/ "Illegal byte sequence", /* 93*/ "Attribute not found",      \
        ...
        /*106*/ "Interface output queue is full", /*max*/ "Unknown error: "  \
  }

#endif

char* s21_strerror(int errnum) {
  static char* errstr[] = ERRORS;
  static char message[64];
  s21_memset(message, 0, 64);
  int errmax = sizeof(errstr) / sizeof(char*) - 1;
  if (errnum < 0 || errnum >= errmax) {
    s21_sprintf(message, "%s%d", errstr[errmax], errnum);
  }
  return (*message) ? message : errstr[errnum];
}